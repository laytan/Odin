...
_pool_arena_init :: proc(arena: ^Pool_Arena, block_size := DEFAULT_BLOCK_SIZE) -> (err: runtime.Allocator_Error) {
	runtime.arena_init(&arena, block_size, runtime.default_wasm_allocator()) or_return
	return
}
