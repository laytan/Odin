...
when ODIN_OS == .Windows {
	...
	when !#exists(LIB) {
		#panic("Could not find the compiled WGPU Native library at '" + #directory + LIB + "', these can be downloaded from https://github.com/gfx-rs/wgpu-native/releases/tag/v27.0.4.0, make sure to read the docs at '" + #directory + "doc.odin'")
	}
